...
> See also: [FR-006 Core Functional Requirements](../requirements/FR-006-core-functional-requirements.md) (shell safety, channel auth)
...
**Mitigations:**
- Default-deny WhatsApp authorization ([FR-001](../requirements/FR-001-whatsapp-auth-flow.md))
- Silent inbound by default ([FR-008](../requirements/FR-008-whatsapp-silent-inbound.md))
